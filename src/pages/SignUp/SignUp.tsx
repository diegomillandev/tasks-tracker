            ...
            <div className="bg-gray-800 p-8 w-11/12 max-w-[450px] rounded-md border border-gray-700">
                ...
                {accountCreated ? (
                    <div className="flex flex-col items-center gap-4">
                        <h3 className="text-2xl text-green-700 font-semibold">
                            Account created successfully
                        </h3>
                        <p className="text-gray-200 text-center text-xl font-extralight">
                            plase check your email to verify your account and
                            sign in.
                        </p>
                    </div>
                ) : (
